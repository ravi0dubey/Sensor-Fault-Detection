...
# like connection name of mongodb will be declared over here

# Define Training Pipeline Configuration Class
...
class DataValidationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.drift_data_dir: str = os.path.join(self.data_validation_dir, training_pipeline.DATA_VALIDATION_DRIFT_REPORT_DIR)       
